    ...
    <x-dialog-modal wire:model="showModal" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="mt-6">
                ...
                <x-input id="profesion" class="block mt-1 w-full" type="text" wire:model.defer="profesion" />
                <x-input-error for="profesion" class="mt-2" />
            </div>

            <div class="mt-6">
                <x-label for="descripcion" value="{{ __('Más detalles') }}" />
                <x-textarea id="descripcion" class="block mt-1 w-full" type="text" wire:model.defer="descripcion"
