    ...
    <x-dialog-modal wire:model="showModal" maxWidth="md">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x-input id="name" class="block mt-1 w-full" type="text" autocomplete="off"
            ...
            <div class="mt-5">
                ...
                <x-textarea id="descripcion" class="block mt-1 w-full" type="text" autocomplete="off"
                    wire:model.defer="descripcion" placeholder="Agrega más detalles del proyectista." />
