...
class RolesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'propuestas.ver'])->syncRoles($admin, $asistente, $escuela, $vri, $estudiante, $docente, $proyectista);
        ...
        Permission::create(['name' => 'postulaciones.ver'])->syncRoles($admin, $asistente, $escuela, $vri);
        ...
        Permission::create(['name' => 'mis-proyectos.ver'])->syncRoles($docente, $estudiante, $proyectista);
