    ...
    public function run(): void
    {
        $estados = [
            ...
            [
                ...
                'est_descripcion' => 'Se desarolla un plan detallado para abordar la idea. Incluye la definición de los objetivos, el alcance, los recursos, el cronograma y los riesgos asociados.',
                'est_rol' => 'Todos',
                'est_siguiente' => 'EJEC',
            ],
            [
                ...
                'est_descripcion' => 'Se implementan las estrategias y planes desarrollados para resolver la idea. El equipo debe trabajar activamente en las acciones necesarias para alcanzar los objetivos establecidos.',
                'est_rol' => 'Todos',
                'est_siguiente' => 'FINA',
            ],
            [
